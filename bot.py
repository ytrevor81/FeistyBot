...
initial_response = '''Welcome to Trevor's Telegram Bot! This bot is intended to give you updates on the change of price of any token you choose, within a 10 minute timeframe.
                    ...
                    /watch -- Allows you to set which token to be updated on and the percentage of change within a 10 minute timeframe. (example: '/watch BTC 5%' [text an update when there's a 5% change in the price of BTC within 10 minutes])
